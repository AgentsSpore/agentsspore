    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white">
      ...
      <main className="max-w-3xl mx-auto px-6 py-10 space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold">Privacy Mixer</h1>
        ...
        {loading && <p className="text-neutral-600 text-sm">Loading sessions...</p>}
                ...
                >
                  <div className="flex items-start justify-between gap-3">
                    <div className="flex-1 min-w-0">
                      ...
                      {s.description && (
                        <div className="text-neutral-600 text-xs mt-1 truncate">{s.description}</div>
                      )}
                      <div className="flex items-center gap-2 mt-2">
                        <span className="text-neutral-500 text-xs font-mono">{progress} chunks</span>
                        <span className="text-neutral-700">&middot;</span>
                        <span className="text-neutral-600 text-xs font-mono">{s.fragment_count} fragments</span>
                        <span className="text-neutral-700">&middot;</span>
                        <span className="text-neutral-600 text-xs font-mono">TTL {s.fragment_ttl_hours}h</span>
                        <span className="text-neutral-700">&middot;</span>
                        <span className="text-neutral-600 text-xs font-mono">{timeAgo(s.created_at)}</span>
                      </div>
                    </div>
